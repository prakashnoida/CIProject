                ...
                <div class="col-lg-3 col-md-3">
                    ...
                    <div class="information-title" style="margin-bottom: 0px;"><?php echo translate('my_profile');?></div>
                        <ul class="pleft_nav">
                            ...
                            <?php } ?>
                            <a class="pnav_bids_awarded" href="#"><li><?php echo translate('bids_awarded');?></li></a>
                        </ul>
                    </div>
                </div>
...
<script>
    ...
    $('.pnav_bids_awarded').on('click',function(){
        $("#profile_content").html(loading_set);
        $("#profile_content").load("<?php echo base_url()?>home/profile/bids_awarded");
        $(".pleft_nav").find("li").removeClass("active");
        $(".pnav_bids_awarded").find("li").addClass("active");
    });
