					...
					<div class="widget contact">
						...
						<div class="media-list">
							...
							<ul class="social-nav model-2" style="float: left;margin-top: 10px">
								...
								if ($facebook != '') {
								?>
								<li style="border-top: none;"><a href="<?php echo $facebook;?>" class="facebook social_a"><i class="fa fa-facebook" style="color:#fff;"></i></a></li>
								<?php
								} if ($twitter != '') {
								?>
								<li style="border-top: none;"><a href="<?php echo $twitter;?>" class="twitter social_a"><i class="fa fa-twitter" style="color:#fff;"></i></a></li>
