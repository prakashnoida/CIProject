                    ...
                    <div class="tab-content">
                        ...
                        <div id="business_details" class="tab-pane fade">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-4">
                                    <input type="radio" name="product_type" onchange="sel_business_type(this.value)" checked id="chk_type" value="fixed"> Fixed Price
...
<script>
    $(document).ready(function(){
        ...
        $.ajax({
            type:"GET",
            data:{a:a},
            url:"<?php echo base_url();?>vendor/sel_business_type",
