                ...
                <div class="tab-base">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="business_details" class="tab-pane fade">
                            <!--
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-6"><?php echo translate('product_type');?></label>
                                <div class="col-sm-4">
                                    <input type="radio" name="product_type" onchange="sel_business_type(this.value)"  id="chk_type" value="fixed"> Fixed Price
                                    <input type="radio" name="product_type" onchange="sel_business_type(this.value)"  id="chk_type" value="auction"> Auction Price
                                </div>
                            </div>
                            -->
                            <p id="business">
                               <?php
                                    if($row['product_type']=='auction')
                                    {
                                        ?>
                                        <div class="form-group btm_border">
                                            <label class="col-sm-4 control-label" for="demo-hor-6"><?php echo translate('base_price');?></label>
                                            <div class="col-sm-4">
                                                <input type="number" name="auction_base_price" id="demo-hor-6" min='0' step='.01' value="<?php echo $row['auction_base_price']; ?>" placeholder="<?php echo translate('base_price');?>" class="form-control required">
                                            </div>
                                        ...
                                        <div class="form-group btm_border">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" name="auction_minimum_price" id="demo-hor-7" min='0' step='.01' value="<?php echo $row['auction_minimum_price']; ?>" placeholder="<?php echo translate('minimum_price_to_sell');?>" class="form-control required">
                                            </div>
                                            <span class="btn"><?php echo currency('','def'); ?> / </span>
                                            <span class="btn unit_set"><?php echo $row['unit']; ?></span>
                                        </div>
                                        ...
                                        <div class="form-group btm_border">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="date" name="auction_start_date" id="demo-hor-7" value="<?php echo $row['auction_start_date']; ?>"  placeholder="<?php echo translate('start_date');?>" class="form-control required">
                                            </div>
                                         ...
                                         <div class="form-group btm_border">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="date" name="auction_end_date" id="demo-hor-7" value="<?php echo $row['auction_end_date']; ?>" placeholder="<?php echo translate('end_date');?>" class="form-control required">
                                            </div>
                                        ...
                                        <div class="form-group btm_border">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" name="shipping_cost" id="demo-hor-8"  value="<?php echo $row['shipping_cost']; ?>" placeholder="<?php echo translate('shipping_cost');?>" class="form-control">
                                            </div>
                                            <span class="btn"><?php echo currency('','def'); ?> / </span>
                                        ...
                                        <div class="form-group btm_border">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" name="tax" id="demo-hor-9"  value="<?php echo $row['tax']; ?>"  placeholder="<?php echo translate('product_tax');?>" class="form-control">
                                            </div>
                                            <div class="col-sm-1">
