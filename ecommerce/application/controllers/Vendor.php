...
class Vendor extends CI_Controller
{
    ...
    public function auction_update()
    {
        ...
        $product_data = $this->db->get_where('tbl_auction', array('auction_id' => $auction_id));
        $product_id=$product_data->row()->product_id;
        
        $data['auction_status'] = 2;
        ...
        $data1['shipping_address'] = json_encode($_POST);
        $data1['vat'] = 0;
        $data1['vat_percent'] = 0;
        $data1['shipping'] = 0;
        $data1['delivery_status'] = '[]';
        $data1['payment_type'] = 'none';
        $data1['payment_status'] = '[]';
        $data1['payment_details'] = 'none';
        $data1['grand_total'] = $product_data->row()->bid_amount;
        $data1['sale_datetime'] = time();
        $data1['delivary_datetime'] = '';
        $data1['buyer'] =  $product_data->row()->user_id;
        $this->db->insert('sale', $data1);

            
    }
    
    public function sel_auction_type()
    {
        if($_GET['a']=='fixed')
        {
            ?>
            <div class="form-group">
                  Bid Amount : <input type="number" class="form-control" name="target_amt" placeholder="Bid Amount">
                  <input type="hidden" class="form-control" name="target_interval" placeholder="Bid Interval">
                  <input type="hidden" class="form-control" name="target_max_amt" placeholder="Max Amount">
             </div>
            <?php
        }
        else
        {
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                  Bid Interval : <input type="number" class="form-control" name="target_interval" placeholder="Bid Interval">
             </div>
             <div class="form-group">
                  Max Amount : <input type="number" class="form-control" name="target_max_amt" placeholder="Max Amount">
             </div>
            <?php
        }
    ...
    public function sel_auction_type1()
    {


        $product_data = $this->db->get_where('tbl_auction', array('auction_id' => $_GET['b1']));
        ...
        if($_GET['a1']=='fixed' && $auction_type=='fixed')
        {
            ?>
            <div class="form-group">
                  Bid Amount : <input type="number" class="form-control"  value="<?php echo $bid_amount;?>"  name="target_amt" placeholder="Bid Amount">
                  <input type="hidden" class="form-control" name="target_interval" placeholder="Bid Interval">
                  <input type="hidden" class="form-control" name="target_max_amt" placeholder="Max Amount">
             </div>
            <?php
        }
        else if($_GET['a1']=='fixed' && $auction_type!='fixed')
        {
            ?>
            <div class="form-group">
                  Bid Amount : <input type="number" class="form-control"   name="target_amt" placeholder="Bid Amount">
        ...
        else if($_GET['a1']=='proxy' && $auction_type =='proxy')
        {
            ?>
            <div class="form-group">
                  Bid Amount : <input type="number" class="form-control"  value="<?php echo $bid_amount;?>" name="target_amt" placeholder="Bid Amount">
             ...
             <div class="form-group">
                  Bid Interval : <input type="number" class="form-control"  value="<?php echo $bid_interval;?>" name="target_interval" placeholder="Bid Interval">
             </div>
             <div class="form-group">
                  Max Amount : <input type="number" class="form-control"  value="<?php echo $bid_max;?>" name="target_max_amt" placeholder="Max Amount">
             </div>
            <?php
        }
        else
    ...
    public function sel_business_type()
    {
        if($_GET['a']=='auction')
        {
        ?>
        <input type="hidden" name="discount" style="display:none;">
        <input type="hideen" name="discount_type"  style="display:none;">
        <input type="hidden" name="sale_price" style="display:none;">
        <input type="hideen" name="purchase_price"  style="display:none;">
        <div class="form-group btm_border">
            <label class="col-sm-4 control-label" for="demo-hor-6"><?php echo translate('base_price');?></label>
            <div class="col-sm-4">
                <input type="number" name="auction_base_price" id="demo-hor-6" min='0' step='.01' placeholder="<?php echo translate('base_price');?>" class="form-control required">
            </div>
        ...
        <div class="form-group btm_border">
            <label class="col-sm-4 control-label" for="demo-hor-7"><?php echo translate('minimum_price_to_sell');?></label>
            <div class="col-sm-4">
                <input type="number" name="auction_minimum_price" id="demo-hor-7" min='0' step='.01' placeholder="<?php echo translate('minimum_price_to_sell');?>" class="form-control required">
            </div>
            <span class="btn"><?php echo currency('','def'); ?> / </span>
            <span class="btn unit_set"></span>
        </div>
         ...
         <div class="form-group btm_border">
            <label class="col-sm-4 control-label" for="demo-hor-7"><?php echo translate('start_date');?></label>
            <div class="col-sm-4">
                <input type="date" name="start_date" id="demo-hor-7" min='0' step='.01' placeholder="<?php echo translate('start_date');?>" class="form-control required">
            </div>
            
        </div>

         <div class="form-group btm_border">
            <label class="col-sm-4 control-label" for="demo-hor-7"><?php echo translate('end_date');?></label>
            <div class="col-sm-4">
                <input type="date" name="end_date" id="demo-hor-7" min='0' step='.01' placeholder="<?php echo translate('end_date');?>" class="form-control required">
            </div>
    ...
    function product($para1 = '', $para2 = '', $para3 = '')
    {
        ...
        if ($para1 == 'do_add') {
            ...
            $data['auction_base_price']          = $this->input->post('auction_base_price');
            $data['auction_minimum_price']       = $this->input->post('auction_minimum_price');
            $data['auction_start_date']          = date('Y-m-d',strtotime($this->input->post('start_date')));
            $data['auction_end_date']            = date('Y-m-d',strtotime($this->input->post('end_date')));
    ...
    function auction1($para1 = '', $para2 = '', $para3 = '')
    {
        if (!$this->crud_model->vendor_permission('auction')) {
            redirect(base_url() . 'vendor');
        }
        if ($para1 == 'list') {
            $this->db->order_by('product_id', 'desc');
            $this->db->where('added_by',json_encode(array('type'=>'vendor','id'=>$this->session->userdata('vendor_id'))));
            $page_data['all_auction'] = $this->db->get('product')->result_array();
            $this->load->view('back/vendor/auction_list', $page_data);
        }
        else {
    ...
    function auction($para1 = '', $para2 = '', $para3 = '')
    {
        if (!$this->crud_model->vendor_permission('auction')) {
            redirect(base_url() . 'vendor');
        }
        ...
        if ($para1 == 'view') 
        {
            ...
            $query = $this->db->query("select * from product c1, tbl_auction c2 , user c3 where 
                c3.user_id=c2.user_id and c1.product_id=c2.product_id and c1.product_id='".$para2."' order by c2.bid_amount desc");
            $page_data['product_data'] = $query->result();
            //print_r($page_data);exit();
            $this->load->view('back/vendor/auction_view', $page_data);
        } 
        elseif ($para1 == 'list') {
            $this->db->order_by('product_id', 'desc');
            $this->db->where('added_by',json_encode(array('type'=>'vendor','id'=>$this->session->userdata('vendor_id'))));
        ...
        elseif ($para1 == 'list_data') 
        {
            ...
            $this->db->where('download=',NULL);
            $this->db->where('product_type','auction');
            $this->db->where('added_by',json_encode(array('type'=>'vendor','id'=>$this->session->userdata('vendor_id'))));
            $total  = $this->db->get('product')->num_rows();
            $this->db->limit($limit);
            if($sort == ''){
